...
window.addEventListener('load', () => {
  ...
  const ids = ['run-eda-btn','export-merged-btn','preprocess-btn','create-model-btn','train-btn','stop-btn','eval-btn','predict-btn','download-btn','download1-btn','threshold-slider'];

        ...
        this.accuracyChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    backgroundColor: sortedAccuracies.map(acc => acc > 60 ? 'rgba(75, 192, 192, 0.8)' : acc > 50 ? 'rgba(255, 205, 86, 0.8)' : 'rgba(255, 99, 132, 0.8)'),
                    borderColor: sortedAccuracies.map(acc => acc > 60 ? 'rgb(75, 192, 192)' : acc > 50 ? 'rgb(255, 205, 86)' : 'rgb(255, 99, 132)'),
                    borderWidth: 1
                }]
            },
